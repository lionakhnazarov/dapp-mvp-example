...
router.post('/me', [AuthMiddleware(ROLE.CUSTOMER), ValidationMiddleware()], UserController.saveProfile)
...
router.post('/sponsor', [AuthMiddleware(ROLE.OWNER),   ValidationMiddleware()], UserController.saveSponsor)
